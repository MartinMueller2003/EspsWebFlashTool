...
try:
    sys.path.insert(0, os.path.normpath(toolspath + "/pyserial")) # Add pyserial dir to search path
    sys.path.insert(0, os.path.normpath(toolspath + "/esptool")) # Add esptool dir to search path
